    ...
    <div class="row">
      ...
      <div class="col-md-4">
            <div class="list-group">  
              ...
              <a href="<?php echo site_url('transaksi') ?>" class="list-group-item" style="text-align: center;background-color: light-blue;border-color: #d9d9d9">jumlah transaksi : <?php echo $total_asset_user; ?></a>  <!-- menampilkan jumlah user -->
            </div>
      </div>
      ...
      <div class="col-md-4">
            <div class="list-group">  
              ...
              <a href="<?php echo site_url('barang') ?>" class="list-group-item" style="text-align: center;background-color: light-blue;border-color: #d9d9d9">jumlah transaksi : <?php echo $total_asset_barang; ?></a>  <!-- menampilkan jumlah user -->
            </div>
    	</div>
